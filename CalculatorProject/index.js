...
function isOperator(buttonText){
  ...
  function buttonClicked(buttonText){
    if(buttonText!='CLR'&& buttonText!='DEL'&&buttonText!='='){
        ...
        if(buttonText==="CLR"){ displayArea.innerText='0';}
        else if(buttonText==='DEL'){ displayArea.innerText=displayArea.innerText.slice(0,-1);}
        else if(buttonText==='='){
            try{ displayArea.innerText=eval(displayArea.innerText);}
            catch(error){ displayArea.innerText=0;}
        }
    }
  }
  */
